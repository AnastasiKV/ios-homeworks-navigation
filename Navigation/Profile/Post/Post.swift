...
struct PostModel {
    ...
    static func makeMockPost() -> [PostModel] {
        ...
        examplePost.append(PostModel(author: "av.kulikovaa", description:  "Фотографии с нашего прекрасного отдыха в Дубае", image: UIImage(named: "post_1")!, likes: 1543, views: 1346))
